...
/*!
  Copyright (c) 2015 Marius Kelpsa.
  Licensed under the MIT License (MIT), see
  http://makeitdoit.github.io/idDefined
*/
...
(function() {
  ...
  function isDefined(obj, path) {
    ...
    if (typeof path === 'undefined') {
      return (typeof obj !== 'undefined'); //if missing path - just check passed object for defined
    }
    ...
    for (i = 0; i < props.length; i++) {
      if (typeof obj[props[i]] === 'undefined') {
        return false;
      } else if (obj[props[i]] === null) {
        return i === props.length - 1; //true if last
      } else {
        obj = obj[props[i]];
      }
    }
...
var Datepicker = React.createClass({
	...
	buildTable: function buildTable(stage, data) {},
	buildSelectBox: function buildSelectBox() {
		var i = undefined,
		    rows = [],
		    values = [],
		...
		if (this.state.stage === 0) {
			for (i = 0; i < 20; i++) {
				values.push(React.createElement(
					'td',
					{ key: year, 'data-key': year, onClick: this.selectYear },
					year
				));
				year++;
				if (i > 0 && (i + 1) % 5 === 0) {
	...
	render: function render() {
		...
		return React.createElement(
			...
			React.createElement('input', { type: 'date', ref: 'value', name: this.props.name, value: this.state.value, disabled: this.props.disabled, placeholder: this.props.placeholder, value: this.state.value }),
			selectBox
		);
	}
...
},{"check-defined":2,"classnames":3,"react":158}],160:[function(require,module,exports){
/**
...
React.render(React.createElement(Datepicker, null), document.getElementById('main'));

},{"./Datepicker":159,"react":158}]},{},[160])
